...
const Navbar = () => {
  ...
  const adjustedScrollPositionRef = useRef(0);
  ...
  useEffect(() => {
    ...
    if (hash) {
      ...
      if (targetElement) {
        adjustedScrollPositionRef.current = targetElement.offsetTop - 100;

        // Scroll to the adjusted position
        window.scrollTo({
          top: adjustedScrollPositionRef.current,
          behavior: "smooth",
        });
      }
    }
              ...
              <div className="flex items-start justify-between">
                <div className=" flex flex-col">
                  <p
                    ...
                    className="text-[40px] md:text-[72px] text-white font-gotham font-semibold cursor-pointer"
                  >
                    About us
                  </p>
                  <p
